 ...
 *
 * Taken from https://gist.github.com/chrisbanes/8391b5adb9ee42180893300850ed02f2
 *
 ...
 *
 * Used in home screen where items could not be clicked for the first time
 * after flinging the RecyclerView.
 *
 * FIXME: Android Studio shows this file as not used, even if it is set in XML
 */
